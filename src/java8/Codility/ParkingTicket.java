...
public class ParkingTicket {
	 public int solution(String E, String L) {
		    ...
		    int ehr = Integer.valueOf(E.split(":")[0]);
		    int emm = Integer.valueOf(E.split(":")[1]);

		    int lhr = Integer.valueOf(L.split(":")[0]);
		    int lmm = Integer.valueOf(L.split(":")[1]);
	 ...
	 public static void main(String[] args) {
		System.out.println(new ParkingTicket().solution("10:00", "13:21"));
	}
}
