...
public class ParkingTicket {
	 public int solution(String e, String l) {
		    ...
		    int ehr = Integer.parseInt(e.split(":")[0]);
		    int emm = Integer.parseInt(e.split(":")[1]);

		    int lhr = Integer.parseInt(l.split(":")[0]);
		    int lmm = Integer.parseInt(l.split(":")[1]);

		    int rate = 5;
		    int diffInMin =  (lhr * 60 + lmm) - (ehr * 60 + emm);
		    diffInMin -= 60;
		    while(diffInMin > 60){
		        rate = rate + 4;
		        diffInMin -= 60;
	 ...
	 public static void main(String[] args) {
		 ...
		 var i = new ParkingTicket().solution("10:00", "13:21");
		 l.log(Level.INFO,"Result {0}", i);
	}
}
